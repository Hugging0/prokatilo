...
const faqPage: SeoPageConfig = {
  ...
  faqs: [
    ...
    {
      question: "Как добавить ПРОКАТило на экран телефона?",
      answer:
        "На iPhone откройте приложение в Safari, нажмите «Поделиться», выберите «На экран „Домой“» и нажмите «Добавить». На Android откройте меню браузера, выберите «Установить приложение» или «Добавить на главный экран» и подтвердите установку.",
    },
  ],
};
