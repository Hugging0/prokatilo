...
export default function App() {
  ...
  const renderAuthView = () => (
    <main className="min-h-screen bg-slate-950 flex items-center justify-center p-6">
      <section className="w-full max-w-sm bg-white rounded-[2rem] p-8 shadow-2xl">
        <div className="w-16 h-16 bg-rose-500 rounded-3xl flex items-center justify-center mb-8 shadow-xl shadow-rose-200">
        ...
        <p className="text-slate-400 font-bold mt-2 mb-8">
          Сервис проката вещей с доставкой за 15 минут
        </p>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl py-4 pl-12 pr-4 text-sm font-bold outline-none focus:border-rose-500"
            />
          </div>

          <button
            type="submit"
            className="w-full bg-slate-900 text-white py-5 rounded-2xl font-black shadow-xl shadow-slate-200 active:scale-95 transition-transform"
          >
            Войти
          </button>
        </form>
  ...
  const renderHomeView = () => (
    <main className="min-h-screen bg-slate-50 pb-28">
      <section className="bg-slate-950 text-white rounded-b-[2.5rem] px-6 pt-12 pb-8 shadow-2xl shadow-slate-200">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2 bg-emerald-400/15 text-emerald-300 px-3 py-2 rounded-2xl text-xs font-black">
      ...
      <main className="min-h-screen bg-white pb-32">
        ...
        <section className="px-6 -mt-10 relative z-10">
          <div className="bg-white rounded-[2.5rem] p-6 shadow-xl shadow-slate-100 border border-slate-100">
            <p
              className={`inline-flex px-3 py-1 rounded-full text-[10px] font-black uppercase ${selectedItem.bg} ${selectedItem.color}`}
            >
    ...
    return (
      <main className="min-h-screen bg-slate-50 px-6 pt-12 pb-32">
        ...
        <button
          type="button"
          onClick={handleBook}
          className="mt-8 w-full bg-rose-500 text-white py-6 rounded-[2rem] font-black text-lg shadow-2xl shadow-rose-200 active:scale-95 transition-transform"
        >
  ...
  const renderAdminDashboard = () => (
    <main className="min-h-screen bg-slate-950 px-6 pt-12 pb-32 text-white">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-3xl font-black">Управление</h2>
          <p className="text-white/40 text-sm font-bold">Владелец</p>
        </div>
  ...
  const renderProfileView = () => (
    <main className="min-h-screen bg-slate-50 px-6 pt-12 pb-32">
      <section className="bg-white rounded-[2rem] p-6 border border-slate-100 shadow-sm">
        <div className="w-20 h-20 rounded-[2rem] bg-slate-900 text-white flex items-center justify-center mb-5">
          <UserIcon size={34} />
        </div>
        ...
        <p className="text-slate-400 font-bold mt-1">{user?.phone}</p>
      </section>
